...
<head>
    ...
    <!-- Core Style CSS -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/core-style.css">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="product-topbar d-xl-flex align-items-end justify-content-between">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="button" id='btn_soldout' autocomplete="off"  aria-pressed='false'>품절 상품 제외 보기</button>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                <img src="${pageContext.request.contextPath}/resources/${p.PRODUCTIMG}" alt="">
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="ratings-cart text-right">
                                    ...
                                    <div class="cart">
                                        <a href="#" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="${pageContext.request.contextPath}/resources/img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<%--                                 <li class="page-item active"><a class="page-link" href="#">${totalPage }</a></li> --%>
                                <c:forEach var="i" begin="1" end="${totalPage }">
                                <li class="page-item"><input type="button" class="page-link pageid" value="${i }"></li>
                            	</c:forEach>
                            </ul>
                        </nav>
                    </div>
	...
	<form action="loadShopPage.shop" method="get" id="frm_prevo">
		<input type="hidden" name="pNum" id="pNum" value="${prevo.pNum }">
		<input type="hidden" name="orderBy" id="orderBy" value="${prevo.orderBy }">
		<input type="hidden" name="maxPrice" id="maxPrice" value="${prevo.maxPrice }">
		<input type="hidden" name="minPrice" id="minPrice" value="${prevo.minPrice }">
		<input type="hidden" name="category" id="category" value="${prevo.category }">
		<input type="hidden" name="soldout" id="soldout" value="${prevo.soldout }">
	</form>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Colorlib</a> & Re-distributed by <a href="#" target="_blank">Themewagon</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	$('#btn_soldout').click(function(){
		...
		if(aria=='false'){
			$('#soldout').attr('value',null);
			 $('#frm_prevo').submit();
			$('#btn_soldout').html('품질 상품 포함 보기');
		}else{
			 $('#soldout').attr('value','true');
			 $('#frm_prevo').submit();
	...
	$('.page-link').click(function(){
		$('#pNum').attr('value',$(this).attr('value'));
		$('#frm_prevo').submit();
